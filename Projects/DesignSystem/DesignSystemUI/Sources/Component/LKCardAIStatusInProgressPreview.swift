//
//  LKCardAIStatusInProgressPreview.swift
//  DesignSystemUI
//
...
struct LKCardAIStatusInProgressPreview: View {
    @State private var aiStatus: LKCardAIStatus = .inProgress
...
#Preview {
    LKCardAIStatusInProgressPreview()
}
